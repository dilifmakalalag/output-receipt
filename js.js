...
function printStruk() {
  ...
  outputHTML += `
          <div class="container" style="width:76mm;border:black 1px solid; padding: 0px; margin: 0px; width: 74mm;">
            <div class="row" style="font-size: 13pt; font-weight: normal; margin: 0mm;">
              <div class="label scaled-text">Date</div>
              <div class="separator">:</div>
              <div class="value scaled-text">${formData.date}</div>
            </div>
            <div class="row" style="font-size: 12pt; font-weight: normal; margin: 0mm;">
          ...
          <div class="container" style="display: flex; flex-direction: row;margin-top:8mm;margin-bottom:3mm;border:black 1px solid; width: 74mm;">
          ...
          <div class="row" style="display: flex; align-items: center; padding: 0; font-size:30px;margin-bottom:3mm;border:black 1px solid;">
            <div class="label">
          ...
          <div class="container" style="display: flex; flex-direction: row;margin-bottom:8mm;border:black 1px solid;width: 74mm;">
          ...
          <div class="container" style="display: flex; flex-direction: row;margin-bottom:0;border:black 1px solid; width: 74mm;">
              <div class="column" style="flex: 1; margin-right: 0px;font-size:9px;">
          ...
          <div class="container" style="display: flex; flex-direction: row; width: 74mm;margin-right:0;margin-top:0;padding-top:0;margin-bottom:8mm;border:black 1px solid;">
              <div class="column" style="flex: 1; margin-right: 0px;font-size:9px;">
                  ${generateRow("Operator", formData.operator)}
              </div>
          </div>
          <p style="text-align:left; width: 74mm;font-size:12px;margin-bottom:0;padding-bottom:0;border:black 1px solid;">TIMES</p>
          <div class="container" style="display: flex; flex-direction: row; font-size:12px; width: 74mm;margin-top:0;padding-top:0;margin-bottom:0;padding-bottom:0;text-align:left;border:black 1px solid;">
          ...
          <p style="text-align:left; width: 74mm;font-size:12px;margin-top:0;padding-top:0;border:black 1px solid;">Fueling Time (Y-X)  MIN</p>
          <div class="container" style=" width: 74mm;margin-top:8mm;border:black 1px solid;">
           <div class="row">
            <div class="label">
            <p style="display: inline-block; transform: scaleX(0.9); transform-origin: left; white-space: nowrap; margin: 0;padding:0;">
              Meter Reg. Num
          ...
          <div style="margin-top: 5mm;margin-bottom:5mm;padding-top:0; width: 74mm;font-size:10px;border:black 1px solid;">
            <p>--------------------------------------------------------------------------------------------------------------</p>
          ...
          <div class="container" style="border:black 1px solid; width: 74mm;">
          ${generateSingleRow("Notes", formData.notes)}
          ${generateSingleRow("Comment", formData.comments)}
          </div>
          <p style="text-align:left; width: 74mm;font-size:12px;margin-bottom:0;padding-bottom:0;margin-top:5mm;border:black 1px solid;">FUELING SAMPLE</p>
          <div class="container" style="margin-top:0;padding-top:0;border:black 1px solid; width: 74mm;">
          ${generateSingleRow("From", formData.fromFuelSample)}
          ${generateSingleRow("Taken", formData.takenFuelSample)}
          </div>
          <div style="margin-top: 0px;padding-top:0; width: 74mm;font-size:12px;border:black 1px solid;">
            <p>========================================<br>====================</p>
            <div style="display: flex; flex-direction: row;margin-top:0;padding-top:0;margin-bottom:0;padding-bottom:0;">
              <div class="column" style="flex: 1;">
          ...
          <p style="text-align:left; width: 74mm;font-size:12px;margin-bottom:0;padding-bottom:0;border:black 1px solid;">PERTAMINA's SIGN</p>
          <div class="container" style="margin-top:0;padding-top:0;border:black 1px solid; width: 74mm;">
          ...
          <p style="text-align:left; width: 74mm;font-size:12px;margin-bottom:0;padding-bottom:0;border:black 1px solid;">CUSTOMER's SIGN</p>
          <div class="container" style="margin-top:0;padding-top:0;border:black 1px solid; width: 74mm;">
          ...
          <html>
            <head>
              ...
              <style>
                ...
                transform-origin: top left; margin-left:1.25mm; }
            ...
            <div style="margin-left:1mm;margin-bottom:8mm;border:black 1px solid;">
